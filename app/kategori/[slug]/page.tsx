...
//                     {/* HEADER */}
//                     <Link href="/kategori" className="inline-flex items-center gap-2 mb-6 px-4 md:px-5 py-2 text-sm md:text-base bg-[#2B87DA] text-white rounded-lg transition-all hover:bg-[#236fb4]">
//                             ← Kembali
//                     </Link>
